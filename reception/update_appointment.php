...
echo $name." ".$doctor.'/'.$phone.'/'.$email.'/'.$department.'/'.$doctor.'/'.$date;
echo "    ".$count;
$sql1 = "
INSERT INTO `appointment`( `app_name`, `app_phone`, `app_email`, `app_doctor`, `app_date`) VALUES ('$name','$phone','$email','$doctor','$date')
"; 
...
";
$message1="your Doctor ".$doctor." 'appointment number is".$count.".";
