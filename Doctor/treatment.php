...
<body>
	...
	<ul id="side-main-menu" class="side-menu list-unstyled">                  
		...
		<li class="active"><a href="forms.html"> <i class="fa fa-stethoscope"></i>Treatment</a></li>
	...
	<section class="forms">
		<div class="container-fluid">
			...
			<header> 
				...
				<h1 class="h3 display">Treatment</h1>
			</header>
			<div class="row">
				<div class="col-lg-12">
								...
								<div class="col-lg-6">
									<form class="form-horizontal">
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input id="inputHorizontalSuccess" type="date" placeholder="Enter date" class="form-control form-control-success" oninput="getdate(this.value)"><small class="form-text"></small>
											</div>
										</div>
									</form>
								</div>
													...
													<li class="clearfix">
														<div class="feed d-flex justify-content-between">
															<div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="covers/<?php echo $row1['p_photo']; ?>" alt="person" class="img-fluid rounded-circle"></a>
																<div class="content">
																	<strong>
																		<?php echo $name.$row['app_date'];?>

																	</strong>
																	<small>
																		Age:<?php echo $row1['p_age'].$precord.'dfdsf'; ?> <br>
															...
															<div class="date"><a href="patienttreatment.php?id=<?php echo $row['p_id']; ?>"  class="btn btn-xs btn-dark">Treatment</a></div>
														</div>
													</li>
													<!-- List-->
													<?php 
