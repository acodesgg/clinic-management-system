  ...
  <div class="menu trans_500">
    ...
    <header class="header" id="header">
      <div>
        ...
        <li class="active" ><a href="aboutusmyan.php"><?= _Aboutus?></a></li>
...
<div class="container">
      <div class="row">
        <div class="col text-center"><br><br>
          <div class="section_title"><?= _a?></div>
         <!--  <div class="section_subtitle"><?= _choose?></div> -->
        </div>
      </div>
      <div class="row about_row row-eq-height">
        <div class="col-lg-4">
          <div class="logo">
            <a href="#"><?= _health?><span>+</span></a>  
          </div>
          <div class="about_text_highlight"><br><?= _by?></div>
      ...
      <div class="row">
        <div class="col">
          <div class="button about_button ml-auto mr-auto"><a href="contactusmyan.php"><span><?=_call?></span><span><?=_call?></span></a></div>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-lg-4 milestone_col">
          ...
          <div class="milestone d-flex flex-row align-items-center justify-content-around">
            ...
            <div class="milestone_content">
              ...
              <div class="milestone_text"><?= _days?></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 milestone_col">
          <div class="milestone d-flex flex-row align-items-center justify-content-around">
            ...
            <div class="milestone_content">
              ...
              <div class="milestone_text"><?= _patients?></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 milestone_col">
          <div class="milestone d-flex flex-row align-items-center justify-content-around">
            ...
            <div class="milestone_content">
              ...
              <div class="milestone_text"><?= _docs?></div>
            </div>
        ...
        <div class="col">
          <div class="cta_container d-flex flex-xl-row flex-column align-items-xl-start align-items-center justify-content-xl-start justify-content-center">
            <div class="cta_content text-xl-left text-center">
              <div class="cta_title"><?= _appoint?></div>
          
            </div>
            <div class="button cta_button ml-xl-auto"><a href="mmbook.php"><span><?= _call?></span><span><?= _call?></span></a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col text-center">
          <div class="section_title"><?= _ourdoc?></div>
          <!-- <div class="section_subtitle"><?= _choose?></div> --><br><br>
        </div>
      </div>
...
<div class="row">
        <div class="col">
          <div class="button doctors_button ml-auto mr-auto"><a href="specialist_dirmyan.php"><span><?=_seeall ?></span><span><?=_seeall ?></span></a></div>
        </div>
      </div>
    </div>
  </div>
