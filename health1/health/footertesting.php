				...
				<div class="row">
					...
					<div class="col-lg-3 footer_col">
						<div class="footer_about">
							...
							<div class="footer_about_text">No.112,Taw Win Road,Dagon</div>
						...
						<div class="footer_hours">
							...
							<ul class="hours_list">
								<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<div class="ml-auto">24 hours</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Address:</div>
									<div class="ml-auto">  No.112,Taw Win Road,Dagon </div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Phone:</div>
									<div class="ml-auto">09112200000</div>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
									<div>Email:</div>
