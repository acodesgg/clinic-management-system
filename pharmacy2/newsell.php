...
<body>
 ...
 <ul id="side-main-menu" class="side-menu list-unstyled">                  
  ...
  <li class="active"><a href="newsell.php"> <i class="fa fa-shopping-cart"></i>New Sell</a></li>
...
<section class="forms">
  ...
  <div class="col" style="margin: 10px 0;">
    <div class="form-inline" >
        <div class="form-group mr-sm-2" style="margin: 0 30px;">
    <select id="inlineFormInput" name="category" class="custom-select form-control mb-2 mr-sm-2 "
...
<div class="form-group mr-sm-2"    id="txtHint"  style="margin: 0 30px;">
  <select name="medicine" id="medicine" class="custom-select">
            <option value="">Choose Medicine</option>

          </select>
</div>
<div class="form-group mr-sm-2"  style="margin: 0 30px;" id="txtHint1"> 
 <div class="input-group mb-3 mr-sm-2 " id="inlineFormInput">
            <input type="number" id="inlineFormInput" class="form-control " placeholder="Enter Qty" id="qty" name="qty">
...
<div class="form-group mr-sm-2"  style="margin: 0 30px;">
   <button  class="btn btn-success " onclick="addrecordtable()">Add Item</button>
        ...
        <div class="form-group" style="margin: 0 2px" id="txtHint1">
          <div class="input-group mb-3 mr-sm-2 " id="inlineFormInput">
            <input type="number" id="inlineFormInput" class="form-control " placeholder="Enter Qty" id="qty" name="qty">
            <div class="input-group-append">
              <span class="input-group-text">10</span>
