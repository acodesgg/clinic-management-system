...
ul.breadcrumb li.a+li.a:before {
  padding: 8px;
  color: black;
  content: "/\00a0";
}
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="newsell.php"  >
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="sellquery.php"  >
          
          <span>Sell Query</span>
        </a>
        
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="invoicequery.php"  >
          
          <span>Invoice Query</span>
        </a>
