    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="covers/<?php echo $rown1['Photo'] ?>" alt="person" class="img-fluid rounded-circle">
            <h2 class="h5"><?php echo $rown1['Name']; ?></h2><span>Admin</span>
          </div>
