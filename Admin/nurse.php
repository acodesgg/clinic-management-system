  ...
  <ul class="nav nav-pills" role="tablist">
    ...
    <li class="nav-item">
      ...
      <div class="card card updates daily-feeds" id="home" >
            ...
            <?php 
            include("connect.php");
            $res="SELECT * FROM staff WHERE Type='nurse'";
            ...
            <div class="table-responsive">
             ...
             <ul class="social-network social-circle">
                        ...
                        <li><a  href="delete.php?id=<?php echo $rows['Staff_Id']."/nurse"?>"class="icoTrash" title="Delete"><i class="fa fa-trash"></i></a></li>
                    </ul>
          </div>
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-notify modal-success modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="heading lead">Nurse Information</p>
...
<!-- Central Modal Medium Success-->
  ...
  <div class="modal-dialog modal-dialog-scrollable modal-notify modal-success modal-xl" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p class="heading lead">Update Nurse Information</p>
...
function getInfo(str) {
  ...
  xmlhttp.open("GET","infonurse.php?id="+str,true);
  xmlhttp.send();
}
</script> 
