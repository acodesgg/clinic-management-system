...
$staffId=(int)$staffId;
$res="SELECT * FROM nurse WHERE Staff_Id='$staffId'";
...
<form class="modal-content animate" action="pharmacist_update.php" method="post">

	<div class="container">
		<label for="nurseList">Pharmacist List</label>
		<input type="text" name="pharmacistList" id="pharmacistList" value="<?php echo $row['Pharmacist_List']; ?>"><br>
