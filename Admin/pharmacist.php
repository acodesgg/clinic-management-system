  ...
  include('include\nav1.php');
   ?>
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Employees</a>
  ...
  <ul class="nav nav-pills" role="tablist">
    ...
    <li class="nav-item">
      ...
      <div class="card card updates daily-feeds" id="home" >
            ...
            <?php 
            include("connect.php");
            $res="SELECT * FROM staff WHERE Type='pharmacist'";
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><ul class="nav">
                        ...
                        <li class="nav-item">
                          <a href="delete.php?id=<?php echo $rows['Staff_Id']."/pharmacist"?>">
                ...
                <div class="modal-dialog modal-dialog modal-lg modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      <h4 class="modal-title">Pharmacist Information</h4>
              ...
              <div class="modal fade" id="myModalUpdate">
                <div class="modal-dialog modal-dialog modal-xl modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <!-- Modal Header -->
                    <div class="modal-header">
                      <h4 class="modal-title">Update Pharmacist Information</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
...
function getInfo(str) {
  ...
  xmlhttp.open("GET","infopharmacist.php?id="+str,true);
  xmlhttp.send();
}
</script> 
